...
export default function EngagementKPI() {
  ...
  const tendencia = data.datasets[0].data[data.datasets[0].data.length - 1] > data.datasets[0].data[0] ? "↑" : "↓"
  ...
  return (
    <div className="dashboard-card">
      <Card
        ...
        footer={
          <div className="card-footer">
            <div className="card-metric" style={{ backgroundColor: "rgba(40, 167, 69, 0.05)" }}>
              <div>
      ...
      >
        <p className="card-description">Porcentaje de engagement de nuestra audiencia en redes sociales.</p>
