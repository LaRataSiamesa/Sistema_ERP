...
export default function TasaConversion() {
  ...
  const crecimiento = (
    (data.datasets[0].data[data.datasets[0].data.length - 1] / data.datasets[0].data[0] - 1) *
    100
  ).toFixed(1)
  ...
  return (
    <div className="dashboard-card">
      ...
      >
        <p className="card-description">Evolución de la tasa de conversión de tus campañas de marketing.</p>
